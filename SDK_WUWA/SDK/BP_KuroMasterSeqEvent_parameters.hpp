...
public:
	...
	uint8                                         Pad_32A8[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         K2Node_Event_DeltaSeconds;                         // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_32A9[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_32AA[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_KuroMasterSeqEvent_C______) == 0x000048, "Wrong size on BP_KuroMasterSeqEvent_C______");
...
static_assert(offsetof(BP_KuroMasterSeqEvent_C______, NeedLoop) == 0x000040, "Member 'BP_KuroMasterSeqEvent_C______::NeedLoop' has a wrong offset!");

// Function BP_KuroMasterSeqEvent.BP_KuroMasterSeqEvent_C.>:„Èþ(pÄ)
// 0x0040 (0x0040 - 0x0000)
struct BP_KuroMasterSeqEvent_C_______p__ final
{
public:
	class FString                                 MaleAssetPath;                                     // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	class FString                                 FemaleAssetPath;                                   // 0x0010(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
static_assert(alignof(BP_KuroMasterSeqEvent_C_______p__) == 0x000008, "Wrong alignment on BP_KuroMasterSeqEvent_C_______p__");
static_assert(sizeof(BP_KuroMasterSeqEvent_C_______p__) == 0x000040, "Wrong size on BP_KuroMasterSeqEvent_C_______p__");
static_assert(offsetof(BP_KuroMasterSeqEvent_C_______p__, MaleAssetPath) == 0x000000, "Member 'BP_KuroMasterSeqEvent_C_______p__::MaleAssetPath' has a wrong offset!");
static_assert(offsetof(BP_KuroMasterSeqEvent_C_______p__, FemaleAssetPath) == 0x000010, "Member 'BP_KuroMasterSeqEvent_C_______p__::FemaleAssetPath' has a wrong offset!");
static_assert(offsetof(BP_KuroMasterSeqEvent_C_______p__, MaleSpineArray) == 0x000020, "Member 'BP_KuroMasterSeqEvent_C_______p__::MaleSpineArray' has a wrong offset!");
static_assert(offsetof(BP_KuroMasterSeqEvent_C_______p__, FemaleSpineArray) == 0x000030, "Member 'BP_KuroMasterSeqEvent_C_______p__::FemaleSpineArray' has a wrong offset!");
...
static_assert(sizeof(BP_KuroMasterSeqEvent_C___Spine__) == 0x000018, "Wrong size on BP_KuroMasterSeqEvent_C___Spine__");
...
static_assert(offsetof(BP_KuroMasterSeqEvent_C___Spine__, NeedLoop) == 0x000010, "Member 'BP_KuroMasterSeqEvent_C___Spine__::NeedLoop' has a wrong offset!");
...
static_assert(sizeof(BP_KuroMasterSeqEvent_C___Spine____Plus_) == 0x000028, "Wrong size on BP_KuroMasterSeqEvent_C___Spine____Plus_");
...
static_assert(offsetof(BP_KuroMasterSeqEvent_C___Spine____Plus_, NeedLoop) == 0x000020, "Member 'BP_KuroMasterSeqEvent_C___Spine____Plus_::NeedLoop' has a wrong offset!");

// Function BP_KuroMasterSeqEvent.BP_KuroMasterSeqEvent_C.­>Spine¨;(pÄ)
// 0x0020 (0x0020 - 0x0000)
struct BP_KuroMasterSeqEvent_C___Spine___p__ final
{
public:
...
static_assert(alignof(BP_KuroMasterSeqEvent_C___Spine___p__) == 0x000008, "Wrong alignment on BP_KuroMasterSeqEvent_C___Spine___p__");
static_assert(sizeof(BP_KuroMasterSeqEvent_C___Spine___p__) == 0x000020, "Wrong size on BP_KuroMasterSeqEvent_C___Spine___p__");
static_assert(offsetof(BP_KuroMasterSeqEvent_C___Spine___p__, MaleSpineArray) == 0x000000, "Member 'BP_KuroMasterSeqEvent_C___Spine___p__::MaleSpineArray' has a wrong offset!");
static_assert(offsetof(BP_KuroMasterSeqEvent_C___Spine___p__, FemaleSpineArray) == 0x000010, "Member 'BP_KuroMasterSeqEvent_C___Spine___p__::FemaleSpineArray' has a wrong offset!");

// Function BP_KuroMasterSeqEvent.BP_KuroMasterSeqEvent_C.síSpine¨;
// 0x0010 (0x0010 - 0x0000)
struct BP_KuroMasterSeqEvent_C_S_Spine__ final
{
public:
	class FString                                 SpineName;                                         // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_KuroMasterSeqEvent_C_S_Spine__) == 0x000008, "Wrong alignment on BP_KuroMasterSeqEvent_C_S_Spine__");
static_assert(sizeof(BP_KuroMasterSeqEvent_C_S_Spine__) == 0x000010, "Wrong size on BP_KuroMasterSeqEvent_C_S_Spine__");
static_assert(offsetof(BP_KuroMasterSeqEvent_C_S_Spine__, SpineName) == 0x000000, "Member 'BP_KuroMasterSeqEvent_C_S_Spine__::SpineName' has a wrong offset!");

// Function BP_KuroMasterSeqEvent.BP_KuroMasterSeqEvent_C.síSpine¨;(pÄ)
// 0x0010 (0x0010 - 0x0000)
struct BP_KuroMasterSeqEvent_C_S_Spine___p__ final
{
public:
	TArray<class FString>                         SpineArray;                                        // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
static_assert(alignof(BP_KuroMasterSeqEvent_C_S_Spine___p__) == 0x000008, "Wrong alignment on BP_KuroMasterSeqEvent_C_S_Spine___p__");
static_assert(sizeof(BP_KuroMasterSeqEvent_C_S_Spine___p__) == 0x000010, "Wrong size on BP_KuroMasterSeqEvent_C_S_Spine___p__");
static_assert(offsetof(BP_KuroMasterSeqEvent_C_S_Spine___p__, SpineArray) == 0x000000, "Member 'BP_KuroMasterSeqEvent_C_S_Spine___p__::SpineArray' has a wrong offset!");
