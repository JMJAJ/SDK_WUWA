...
public:
	...
	static void ______P___(const struct FVectorDouble& __P_, class AActor* ___r, class UObject* __WorldContext, float* Param_____);
	...
	static void ______0(const struct FVectorDouble& __, const struct FVectorDouble& ___, const struct FVectorDouble& ______, class UObject* __WorldContext, bool* Param______);
	...
	static void __Ol_______P_(float __, float _l, float ___0, const struct FVectorDouble& ___1, const struct FVectorDouble& ___, bool ThreeD_l, class UObject* __WorldContext, struct FVectorDouble* P__);
	static void __P______(const struct FVectorDouble& W_P_, const struct FVectorDouble& ___P_, class ATsBaseCharacter_C* __, class UObject* __WorldContext, bool* P____, struct FVectorDouble* __P_, float* __P_______);
	...
	static void _e_Z_Double(const struct FVectorDouble& InVec, class UObject* __WorldContext, struct FVectorDouble* OutVec);
	static void ____P_(class ATsBaseCharacter_C* _r, const class FString& Key, class UObject* __WorldContext, struct FVectorDouble* Mn);
