...
public:
	...
	uint8                                         Pad_31AE[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_31AF[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_31B0[0x3];                                     // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_31B1[0x3];                                     // 0x00BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_31B2[0xC];                                     // 0x00D4(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	float                                         CallFunc_BreakVector_Y;                            // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_BreakVector_Z;                            // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_31B3[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(Audio_Multi_Base_C___A___) == 0x000008, "Wrong alignment on Audio_Multi_Base_C___A___");
static_assert(sizeof(Audio_Multi_Base_C___A___) == 0x000038, "Wrong size on Audio_Multi_Base_C___A___");
...
static_assert(offsetof(Audio_Multi_Base_C___A___, CallFunc_Conv_VectorToVectorDouble_ReturnValue) == 0x000010, "Member 'Audio_Multi_Base_C___A___::CallFunc_Conv_VectorToVectorDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Audio_Multi_Base_C___A___, CallFunc_FMax_ReturnValue) == 0x000028, "Member 'Audio_Multi_Base_C___A___::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(Audio_Multi_Base_C___A___, CallFunc_FMax_ReturnValue_1) == 0x00002C, "Member 'Audio_Multi_Base_C___A___::CallFunc_FMax_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Audio_Multi_Base_C___A___, CallFunc_FMin_ReturnValue) == 0x000030, "Member 'Audio_Multi_Base_C___A___::CallFunc_FMin_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_31B4[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_31B5[0x8];                                     // 0x0048(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(Audio_Multi_Base_C___Minus__, CallFunc_GetChildrenComponents_Children) == 0x000018, "Member 'Audio_Multi_Base_C___Minus__::CallFunc_GetChildrenComponents_Children' has a wrong offset!");
static_assert(offsetof(Audio_Multi_Base_C___Minus__, ___int_Loop_Counter_Variable) == 0x000028, "Member 'Audio_Multi_Base_C___Minus__::___int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(Audio_Multi_Base_C___Minus__, CallFunc_Array_Length_ReturnValue) == 0x00002C, "Member 'Audio_Multi_Base_C___Minus__::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Audio_Multi_Base_C___Minus__, CallFunc_Less_IntInt_ReturnValue) == 0x000034, "Member 'Audio_Multi_Base_C___Minus__::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Audio_Multi_Base_C___Minus__, CallFunc__________) == 0x000038, "Member 'Audio_Multi_Base_C___Minus__::CallFunc__________' has a wrong offset!");
static_assert(offsetof(Audio_Multi_Base_C___Minus__, ___int_Array_Index_Variable) == 0x000044, "Member 'Audio_Multi_Base_C___Minus__::___int_Array_Index_Variable' has a wrong offset!");
