...
// struct FSD_KuroTraceCloudData           Param_LerpData                                         (Parm, OutParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_KuroVolumeCloud_Global_C::GetLerpGIData(float Time, struct FSD_KuroTraceCloudData* Param_LerpData)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_LerpData != nullptr)
		*Param_LerpData = std::move(Parms.Param_LerpData);
}
