...
// (Public, Delegate)
// Parameters:
// bool                                    InForbidWeather                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AKuroGlobalGI::OnForbidWeatherStateChangedDelegate__DelegateSignature(bool InForbidWeather)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("KuroGlobalGI", "OnForbidWeatherStateChangedDelegate__DelegateSignature");

	Params::KuroGlobalGI_OnForbidWeatherStateChangedDelegate__DelegateSignature Parms{};

	Parms.InForbidWeather = InForbidWeather;
...
void UKuroMaterialControllerComponent::AddColorUpdateParamPermanentByIndex(class FName Param_Name, const struct FLinearColor& Value, class FName BodyName, int32 MaterialIndex)
{
	static class UFunction* Func = nullptr;
...
void UKuroMaterialControllerComponent::AddFloatUpdateParamPermanentByIndex(class FName Param_Name, float Value, class FName BodyName, int32 MaterialIndex)
{
	static class UFunction* Func = nullptr;
...
void UKuroMaterialControllerComponent::AddTextureUpdateParamPermanentByIndex(class FName Param_Name, class UTexture* Value, class FName BodyName, int32 MaterialIndex)
{
	static class UFunction* Func = nullptr;
...
void UKuroMaterialControllerComponent::RemoveColorUpdateParamPermanentByIndex(class FName Param_Name, class FName BodyName, int32 MaterialIndex)
{
	static class UFunction* Func = nullptr;
...
void UKuroMaterialControllerComponent::RemoveFloatUpdateParamPermanentByIndex(class FName Param_Name, class FName BodyName, int32 MaterialIndex)
{
	static class UFunction* Func = nullptr;
...
void UKuroMaterialControllerComponent::RemoveTextureUpdateParamPermanentByIndex(class FName Param_Name, class FName BodyName, int32 MaterialIndex)
{
	static class UFunction* Func = nullptr;
