...
public:
	...
	float                                         XA_UD__;                                           // 0x0EC8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         XA_RL__;                                           // 0x0ECC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         __;                                                // 0x0ED0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          __Minus_XA;                                        // 0x0ED4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(UABP_SoarWing_C, XA_UD__) == 0x000EC8, "Member 'UABP_SoarWing_C::XA_UD__' has a wrong offset!");
static_assert(offsetof(UABP_SoarWing_C, XA_RL__) == 0x000ECC, "Member 'UABP_SoarWing_C::XA_RL__' has a wrong offset!");
static_assert(offsetof(UABP_SoarWing_C, __) == 0x000ED0, "Member 'UABP_SoarWing_C::__' has a wrong offset!");
static_assert(offsetof(UABP_SoarWing_C, __Minus_XA) == 0x000ED4, "Member 'UABP_SoarWing_C::__Minus_XA' has a wrong offset!");
