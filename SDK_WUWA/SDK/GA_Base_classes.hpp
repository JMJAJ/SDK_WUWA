...
public:
	...
	void _n_6__(const struct FVectorDouble& Param___);
	...
	void __P9(class ATsBaseCharacter_C* ___, const class FString& P9ID, const struct FTransformDouble& ___b, const struct FVectorDouble& ____0, int32* P9);
	void _____0(class ATsBaseCharacter_C* ___, class FName __ID, class AActor* Param_____, class FName Socket, bool* _____);
	void __(int32 MnhID, const struct FTransformDouble& __Mn, bool* ___, class ATsBaseCharacter_C** __i, int32* _SID);
	void _TQ(bool* TQ);
	...
	void __0bP__(const struct FVectorDouble& ___, float __, struct FVectorDouble* ZerobP_, bool* _X_);
	...
	int32 __v__yH(const class UObject* DA___, const struct FTransformDouble& Transform, bool AttachToCharacter);
	...
	void ____Vector(class ATsBaseCharacter_C* _r, const class FString& Key, struct FVectorDouble* _);
	void _n__Vector(class ATsBaseCharacter_C* _r, const class FString& Key, const struct FVectorDouble& _);
	...
	void ________D_____(class AActor* __Actor, float _l, float __, float ___0, struct FVectorDouble* ___, bool* ____);
	void ____0______(class ATsBaseCharacter_C* __Actor, const struct FVectorDouble& __, struct FVectorDouble* ___, bool* ____);
	void ____c______(class AActor* __Actor, float ____, struct FVectorDouble* ___, bool* _____0);
	void ___S_______K(float ___J_, float ___J__0, float __J_, float __J__0, const struct FVectorDouble& W_, const struct FVectorDouble& __, struct FVectorDouble* ___);
	...
	bool _n_rMn(class ATsBaseCharacter_C* _r, const struct FVectorDouble& Location, bool Sweep, bool Teleport, const class FString& Context);
	bool _n_r_l(class ATsBaseCharacter_C* _r, const struct FRotator& Rotation, bool Sweep, const class FString& Context);
	void _n_r_b(class ATsBaseCharacter_C* _r, const struct FTransformDouble& Transform, bool Sweep, const class FString& Context);
	void _n_rMn__l(class ATsBaseCharacter_C* _r, const struct FVectorDouble& Location, const struct FRotator& Rotation, bool Sweep, const class FString& Context);
	...
	void ___r_LMn(class ATsBaseCharacter_C* _r, const struct FVectorDouble& Location, bool Sweep, bool Teleport, const class FString& Context);
	void _n_r__(class ATsBaseCharacter_C* _r, const struct FVectorDouble& Location, const struct FRotator& Rotator, const class FString& Context);
