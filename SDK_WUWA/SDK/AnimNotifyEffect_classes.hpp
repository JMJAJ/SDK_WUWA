...
public:
	...
	uint8                                         Pad_32E5[0x2];                                     // 0x0086(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_32E6[0x3];                                     // 0x00BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool TraceDetectClimbStep(class ATsBaseCharacter_C* Param_Outer, const struct FTransform& OutTrans);
	bool IsDisablePostProcess(class USkeletalMeshComponent* MeshComp);
	void AttachEffectAndSetupTransform(class AActor* Param_Outer, float EffectHandle);
