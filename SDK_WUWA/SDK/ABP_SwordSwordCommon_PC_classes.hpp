...
{
public:
	uint8                                         Pad_38F4[0x8];                                     // 0x0618(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class ATsBaseCharacter_C*                     _r__;                                              // 0x09C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          WeaponOpen;                                        // 0x09D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_38F5[0x3];                                     // 0x09D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          Fh___;                                             // 0x09DC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          __s_fh;                                            // 0x09DD(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          IsUI;                                              // 0x09DE(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_38F6[0x1];                                     // 0x09DF(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Fh_4I_;                                            // 0x09E0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UABP_SwordSwordCommon_PC_C, _r__) == 0x0009C8, "Member 'UABP_SwordSwordCommon_PC_C::_r__' has a wrong offset!");
...
static_assert(offsetof(UABP_SwordSwordCommon_PC_C, Fh___) == 0x0009DC, "Member 'UABP_SwordSwordCommon_PC_C::Fh___' has a wrong offset!");
static_assert(offsetof(UABP_SwordSwordCommon_PC_C, __s_fh) == 0x0009DD, "Member 'UABP_SwordSwordCommon_PC_C::__s_fh' has a wrong offset!");
...
static_assert(offsetof(UABP_SwordSwordCommon_PC_C, Fh_4I_) == 0x0009E0, "Member 'UABP_SwordSwordCommon_PC_C::Fh_4I_' has a wrong offset!");
