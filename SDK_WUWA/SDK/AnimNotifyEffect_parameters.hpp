...
{
public:
	class ATsBaseCharacter_C*                     Param_Outer;                                       // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_32E7[0x8];                                     // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AnimNotifyEffect_C_TraceDetectClimbStep, Param_Outer) == 0x000000, "Member 'AnimNotifyEffect_C_TraceDetectClimbStep::Param_Outer' has a wrong offset!");
...
{
public:
	class AActor*                                 Param_Outer;                                       // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(AnimNotifyEffect_C_AttachEffectAndSetupTransform, Param_Outer) == 0x000000, "Member 'AnimNotifyEffect_C_AttachEffectAndSetupTransform::Param_Outer' has a wrong offset!");
